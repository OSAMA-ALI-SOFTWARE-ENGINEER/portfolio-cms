...
import { useDuplicateBlog } from "../blog/useDuplicateBlog";
...
const BlogManagement = () => {
  ...
  const { duplicateBlog, isDuplicating } = useDuplicateBlog();
                                ...
                                {activeTab === 'trash' ? (
                                  ...
                                  <>
                                    ...
                                    <button
                                      ...
                                      className="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 disabled:opacity-50 dark:text-gray-200 dark:hover:bg-gray-700"
                                      onClick={() => {
                                        duplicateBlog(blog.id);
                                        setIsMenuOpen(null);
                                      }}
                                    >
